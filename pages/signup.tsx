...
export default function SignUpPage() {
  ...
  if (error) {
    ...
    setMessage(isLogin ? 'Login effettuato! Reindirizzamento in corso...' : 'Registrazione completata!');
    
    // ⏳ Redirect dopo 2 secondi solo se login
    if (isLogin) {
      setTimeout(() => {
        router.push('/');
      }, 2000);
  ...
  return (
    <div className={styles.signupContainer}>
      {/* 🌟 Titolo principale sopra la card */}
